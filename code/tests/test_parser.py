...
class TestParser:
    ...
    def test_given_valid_input_when_json_parser_then_return_parsed_data(self, json_valid_input):
        # Given 
    ...
    def test_given_valid_input_when_json_parser_then_return_parsed_data(self, json_valid_input_empty_movement_and_hit_data):
        # Given 
    ...
    def test_given_player_movement_data_when_parse_movements_then_return_player_movement(self, json_valid_input):
        # Given
    ...
    def test_given_player_empty_movement_data_when_parse_movements_then_return_empty_list(self, json_valid_input_empty_movement_and_hit_data):
        # Given
    ...
    def test_given_player_valid_date_when_parse_hits_return_player_hits(self, json_valid_input):
        # Given
        json_input = json.loads(json_valid_input)
        player_one = json_input.get("player1")
        player_two = json_input.get("player2")
    ...
    def test_given_player_empty_hit_data_when_parse_hits_then_return_empty_list(self, json_valid_input_empty_movement_and_hit_data):
            # Given
            json_input = json.loads(json_valid_input_empty_movement_and_hit_data)
            player_one = json_input.get("player1")
            player_two = json_input.get("player2")
